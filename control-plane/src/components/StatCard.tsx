  ...
  return (
    <div className={cn("panel flex flex-col gap-3 p-4", className)}>
          ...
          {tooltip && (
            <Tooltip>
              <TooltipTrigger asChild>
                <button type="button" aria-label={`About ${label}`} className="text-muted-foreground/70 transition-colors hover:text-foreground">
      ...
      <div className="flex items-baseline gap-1.5">
        <span className="tabular text-2xl leading-none font-semibold">{value}</span>
